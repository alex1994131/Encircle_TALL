...
<div class="flex flex-wrap">
    <x-inputs.group class="w-full">
        <x-inputs.select name="trust_id" label="Trusts">
            ...
            <option {{ empty($selected) ? 'selected' : '' }}>For All Trusts</option>
    ...
    <x-inputs.group class="col-span-6 sm:col-span-2">
        <x-inputs.text list="conditions" name="condition_id" id="sel_conditions" label="Condition"
            value="{{ old('condition', ($editing ? $campaign->getCondition->name : '')) }}"
    ...
    <x-inputs.group class="col-span-6 sm:col-span-2">
        <x-inputs.text list="subconditions" name="subCondition_id" label="Subcondition"
            value="{{ old('subcondition', ($editing ? $campaign->getSubCondition->name : '')) }}"
    ...
    <div class="w-full">
        <div id="message_wrapper">
            ...
            @if($library)
            <div id="messagediv_{{$loop->index}}" class="border-1 bg-gray-100 pt-4 mt-2 pb-6 flex flex-wrap">
            ...
            @endforeach
            @else
            <div id="messagediv_0" class="border-1 bg-gray-100 pt-4 mt-2 pb-6 flex flex-wrap">
...
$('body').on('click', '.back_edit_patient', function() {
    console.log('aa')
    document.location.href = `${base_url}/patients/${patient.id}/edit`
})
</script>
